...
parser = argparse.ArgumentParser(description='Gaussian mixture VAE Example')
...
if __name__ == '__main__':
    if args.source_data == 'MNIST':
        ...
        prior = gmvae.Prior(data_size=[args.K, args.z_dim])
    else:
    ...
    torch.save(model.state_dict(),
               '{}/gmvae_model_{}_{}.pt'.format(args.resultpath, args.model_type, args.source_data))
    torch.save(prior.state_dict(),
               '{}/gmvae_prior_{}_{}.pt'.format(args.resultpath, args.model_type, args.source_data))
    with open('{}/gmvae_loss_{}_{}.pkl'.format(args.resultpath, args.model_type, args.source_data), 'wb') as f:
        pickle.dump(loss, f)
    print('\n')
